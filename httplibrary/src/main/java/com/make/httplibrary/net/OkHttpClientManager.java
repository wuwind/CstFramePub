...
//                        .addHeader("Accept-Encoding", "gzip, deflate")
    ...
    private String _dealResponse(Request request) {
        try {
            ...
            LogUtils.e("request tag: " + (request.tag()));
    ...
    private void deliveryResult(final ResultCallback callback, final Request request) {
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(final Call call, final IOException e) {
                ...
                com.make.httplibrary.net.Response res = (com.make.httplibrary.net.Response) o;
...
//                    LogUtils.e("response tag: " + (call.request().tag()));
                    if (response.isSuccessful()) {
                        final String string = response.body().string();
                        LogUtils.e("response url:" + call.request().url());
                        LogUtils.e("response : " + string);
