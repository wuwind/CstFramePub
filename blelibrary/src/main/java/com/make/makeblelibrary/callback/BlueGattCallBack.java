package com.make.makeblelibrary.callback;
...
public class BlueGattCallBack extends BluetoothGattCallback {
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        ...
        //System.out.println(gatt+">>"+status+">>"+newState);
    ...
    public boolean write_data(String data) {
        characteristic_write.setWriteType(write_type);
        characteristic_write.setValue(data);
        return bluetoothGatt.writeCharacteristic(characteristic_write);
    }

    public boolean write_data(byte by[]) {
