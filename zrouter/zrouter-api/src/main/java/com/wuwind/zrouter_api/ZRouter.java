...
public class ZRouter {
     ...
     * @return
     */
    Object navigation(Postcard postcard, Activity activity, int requestCode) {
    ...
    private Object startActivity(final Postcard postcard, final Activity activity, final int requestCode) {
